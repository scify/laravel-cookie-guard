...
<body id="scify-cookie-policy-page">
    <div class="container p-5">
        <div class="row">
            <div class="col-lg-9 col-sm-12 mx-auto my-3">
                <button class="btn btn-secondary text-lg" id="close-cookie-policy-page"
                        aria-label="{{ __('cookies_consent::messages.close_btn') }}">
                    ...
                    {{ __('cookies_consent::messages.close_btn') }}
                </button>
            </div>
        </div>
        <div class="row">
